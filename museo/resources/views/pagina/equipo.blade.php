            ...
            <div class="row g-margin-b-10--xs">
                ...
                <div class="col-md-5 g-margin-b-10--xs g-margin-b-0--lg g-margin-t-10--lg g-margin-l-20--lg">
                    <div class="g-margin-b-30--xs">
                        ...
                        <p class="g-font-size-16--sm" ALIGN="justify" >La Asociación Sacándole Brillo a Xela fue fundada en enero de 2011, por un grupo conformado por treinta quezaltecos, quienes estaban preocupados por el estado de espacios urbanos y la deficiencia de la administración pública en el municipio de Quetzaltenango. Su comienzo está basado en pequeños proyectos, que consistían en preservar el estado de los árboles para impedir que los troncos de estos fueran usados como publicidad o espacios de anuncio por parte de las personas.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="s-promo-block-v2  g-bg-position--center swiper-slide">
           <div class="container g-padding-y-80--xs g-padding-y-100--sm ">
                ...
                <ul class="list-inline row g-margin-b-100--xs">
                    <li class="col-sm-4 col-xs-6 g-full-width--xs  g-margin-b-60--xs g-margin-b-0--md">
                        <div class="center-block g-text-center--xs">
                            <div class="g-margin-b-30--xs">
                            </div>
                            <div class="g-padding-x-20--xs">
                                <h3 class="g-font-size-36--xs g-color--white">Misión</h3>
                                <p class="g-color--white-opacity g-font-size-20--sm" ALIGN="left">Elevar, mediante proyectos de urbanización, equipo médico y ayuda social, la calidad de vida de los habitantes quetzaltecos.</p>
                            </div>
                        </div>
                    </li>
                    <!-- End Process -->
                    ...
                    <li class="col-sm-4 col-xs-6 g-full-width--xs  g-margin-b-60--xs g-margin-b-0--md">
                        <div class="center-block g-text-center--xs">
                            ...
                            <div class="g-padding-x-20--xs">
                                ...
                                <p class="g-color--white-opacity g-font-size-20--sm" ALIGN="left">Construir una ciudad limpia y ordenada, con ciudadanos orgullosos de la misma, participativos e íntegros.</p>
                    ...
                    <!-- Process -->
                    <li class="col-sm-4 col-xs-6 g-full-width--xs  g-margin-b-60--xs g-margin-b-0--sm">
                        <div class="center-block g-text-center--xs">
                            <div class="g-margin-b-30--xs">
                            </div>
                            <div class="g-padding-x-20--xs">
                                <h3 class="g-font-size-36--xs g-color--white">Objetivos</h3>
                                <p class="g-color--white-opacity g-font-size-20--sm" ALIGN="left">Crear proyectos y actividades que beneficien a la población.</p>
                                <p class="g-color--white-opacity g-font-size-20--sm" ALIGN="left">Promover una ciudad sustentable, con responsabilidad ciudadana.</p>
                                <p class="g-color--white-opacity g-font-size-20--sm" ALIGN="left">Proyectar un ambiente agradable en los espacios públicos.</p>
                            </div>
                        </div>
                    </li>
                </ul>
