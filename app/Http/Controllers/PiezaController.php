...
//referencias de los modelos necesarios en este controlador
use App\pieza;
use App\tipo_pieza;
use App\genero;
...
class PiezaController extends Controller
{
    ...
    {
      //Extrae la información de las piezas que esten activas
    ...
    {
      //$pieza = pieza::join('fichas_informativas','piezas.id','=','fichas_informativas.id_pieza')->get();
      $pieza = pieza::all();
    ...
    {
      //extrae la pieza, ficha informativa, ficha tecnica y adquisicon con el ID de la pieza que se quiere eliminar
