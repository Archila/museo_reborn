...
<head>
    ...
    <link rel="icon" href="Images/mphoto.png" sizes="32x32">
    ...
    <style media="screen">
      ...
      main {flex: 1 0 auto;}</style>
    <script src="{{URL::asset('../cdn.transifex.com/live.js')}}"></script>
