...
<div class="container">
  <div class="row">
    <div class="left">
      <h5 class="light left">Libros de editorial </h5><h5 class="medium left">  {{ $editorial->nombre}} </h5>
    </div>
    <div class="right"><br>
      <a href="{{route('Editorial.create')}}" class="modal-trigger btn-floating tooltipped btn-large waves-effect waves-light  light-blue darken-4" data-position="bottom" data-delay="50" data-tooltip="Agregar"><i class="material-icons">add</i></a>
    </div>
  </div>
